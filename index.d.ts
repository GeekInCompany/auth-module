...
declare class LocalScheme<
  ...
  reset({ resetInterceptor }?: { resetInterceptor?: boolean }): void
...
declare class Oauth2Scheme<
  ...
  mounted(): Promise<HTTPResponse | void>
  reset(): void
  login(_opts?: { state?: string; params?: any; nonce?: string }): Promise<void>
  logout(): void
  fetchUser(): Promise<void>
  _handleCallback(): Promise<boolean | void>
  refreshTokens(): Promise<HTTPResponse | void>
  protected updateTokens(response: HTTPResponse): void
  protected pkceChallengeFromVerifier(
    v: string,
    hashValue: boolean
  ): Promise<string>
...
declare class ConfigurationDocument {
  ...
  _set(
    value: OpenIDConnectConfigurationDocument | boolean
  ): boolean | OpenIDConnectConfigurationDocument
...
declare type PartialExcept<T, K extends keyof T> = RecursivePartial<T> &
  Pick<T, K>
...
declare type SchemePartialOptions<
  Options extends SchemeOptions
> = PartialExcept<Options, keyof SchemeOptions>
...
declare type ProviderOptionsKeys = Exclude<
  keyof ProviderOptions,
  'clientSecret'
>
declare type ProviderPartialOptions<
...
interface LaravelJWTProviderOptions
  extends ProviderOptions,
    RefreshSchemeOptions {
  url: string
}
declare function laravelJWT(
  _nuxt: any,
  strategy: ProviderPartialOptions<LaravelJWTProviderOptions>
): void

interface LaravelPassportProviderOptions
  extends ProviderOptions,
    Oauth2SchemeOptions {
  url: string
}
interface LaravelPassportPasswordProviderOptions
  extends ProviderOptions,
    RefreshSchemeOptions {
  url: string
}
...
declare function laravelPassport(
  nuxt: any,
  strategy: PartialPassportOptions | PartialPassportPasswordOptions
): void

interface LaravelSanctumProviderOptions
  extends ProviderOptions,
    CookieSchemeOptions {
  url: string
}
declare function laravelSanctum(
  _nuxt: any,
...
export {
  ...
  ConfigurationDocumentRequestError,
  CookieScheme,
  CookieSchemeCookie,
  ...
  Oauth2SchemeOptions,
  OpenIDConnectConfigurationDocument,
  OpenIDConnectScheme,
